...
// uses other queries to source the department information. 
// Because duplicate names are possible, the ID is attached and then split for use with the SQL Create
  const addRole = async () => {
